...
public class Magazyn extends JPanel{
    ...
    public Magazyn(PrintWriter wyslij, BufferedReader odbierz, String linia, Integer poziom, String pozycja){
        ...
        tmp = linia.split("@");
        this.wyslij.println("Magazyn@"+(poziom+1));
        this.wyslij.flush();
        ...
        ilustracja = new JLabel(new ImageIcon(this.getClass().getResource("magazyn.png")));
            ...
            try{
                while((linia=odbierz.readLine())!=null){
                    ...
                    if(tmp[0].equals("Opis")){
                        ...
                        opis.setText("<html>"+tmp[7]+".<br> By rozbudować ten budynke potrzebujesz "+tmp[6]+". <br>Następny poziom magazynu umożliwi Ci przechowanie "+tmp[5]+"surowców </html>");
                        Magazyn.this.validate();
                        Magazyn.this.repaint();
                    }
                    if(tmp.length > 55 ){
                        Magazyn.this.linia = linia;
                    } 
                }
            }
            catch(IOException e){
    ...
    class Powrot implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, Magazyn.this);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(drewno < 0 || glina < 0 || zelazo < 0 || zboze< 0){
                ...
                String sql = "UploadBudynek@"+drewnoIlosc.getText()+"@"+glinaIlosc.getText()+"@"+zelazoIlosc.getText()+"@"+
                        zbozeIlosc.getText()+"@Magazyn@"+(poziom+1)+"@"+pozycja;
                wyslij.println(sql);
                wyslij.flush();
                try{
                    Thread.sleep(200);
