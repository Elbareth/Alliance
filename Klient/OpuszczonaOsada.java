 ...
 * @author lenovo
 */
public class OpuszczonaOsada extends JPanel{
    ...
    private JButton podbij;
    public OpuszczonaOsada(PrintWriter wyslij, BufferedReader odbierz, String linia, String nazwa, String wlasciciel, Integer id){
        ...
        add(wlascicielLabel);
        obraz = new JLabel(new ImageIcon(this.getClass().getResource("trawaMax.jpg")));
        obraz.setPreferredSize(new Dimension(650,400));
        add(obraz);
        podbij = new JButton("Podbij osade");
        podbij.setPreferredSize(new Dimension(200,50));
        add(podbij);
    ...
    class Powrot implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, OpuszczonaOsada.this);
        ...
        public void run() {
            ...
            try{
                while((linia = odbierz.readLine())!=null){
                    ...
                    if(tmp.length > 55 ){
                        OpuszczonaOsada.this.linia = linia;
