 ...
 * @author lenovo
 */
//Dodaj przycisk przeglad wojsk
//Sprawdzanie czy moge to wojsko w ogole wybudowac!!!!
//Oraz sprawdzenie czy moge dalej rozbudowywac koszary
public class Koszary extends JPanel{
    ...
    public Koszary(PrintWriter wyslij, BufferedReader odbierz, String linia, Integer poziom, String pozycja){
        ...
        this.wyslij.println("Koszary@"+(poziom+1));
        this.wyslij.flush();
        ...
        tytul = new JLabel("Koszary poziom "+poziom);
        ...
        ilustracja = new JLabel(new ImageIcon(this.getClass().getResource("koszary.png")));
    ...
    class Powrot implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, Koszary.this);
                ...
                while((linia=odbierz.readLine())!=null){                    
                    ...
                    for(int i=0;i<tak.length;i++){                        
                        ...
                        if(tmp[0].equals("Opis")){
                            ...
                            wyslij.println("WojskoKoszary");
                            wyslij.flush();
                            Koszary.this.validate();
                            Koszary.this.repaint();                           
                        }
                        if(tmp.length == 9){
    ...
    class Buduj implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(drewno < 0 || glina < 0 || zelazo < 0 || zboze< 0){
                JOptionPane.showMessageDialog(null,"Masz za mało surowców by wybudować koszary");
            ...
            if(czyMoznaBudowac){
                ...
                String sql = "UploadBudynek@"+drewnoIlosc.getText()+"@"+glinaIlosc.getText()+"@"+zelazoIlosc.getText()+"@"+
                        zbozeIlosc.getText()+"@Koszary@"+(poziom+1)+"@"+pozycja;
                wyslij.println(sql);
                wyslij.flush();
                try{
                    Thread.sleep(200);
        ...
        public void actionPerformed(ActionEvent e) {            
            ...
            if(tak.equals("Koszary")){
                if(poziom < Integer.parseInt(wymagania)){
                    JOptionPane.showMessageDialog(null,"Nie możesz wyszkolić tej jednostki. Rozbuduj Koszary");
                    czyMoznaSzkolic = false;
                }
            }
            if(czyMoznaSzkolic){
    ...
    class PrzegladWojskTmp implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, Koszary.this);
            parent.getContentPane().removeAll();            
            parent.add(new PrzegladWojsk(wyslij, odbierz,linia, "Koszary", poziom, pozycja));
            parent.validate();
            parent.repaint();
        }        
    }    
