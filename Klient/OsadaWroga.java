 ...
 * @author lenovo
 */
public class OsadaWroga extends JPanel{
    ...
    private JButton wyslijWiadomosc;
    public OsadaWroga(PrintWriter wyslij, BufferedReader odbierz, String linia, String nazwa, String wlasciciel, Integer id){
        ...
        add(nazwaLabel);
        wlascicielLabel = new JLabel("Właściciel: "+wlasciciel);
        ...
        add(wlascicielLabel);
        obraz = new JLabel(new ImageIcon(this.getClass().getResource("osadaWrogaMax.png")));
        ...
        add(wyslijWojsko);
        wyslijWiadomosc = new JButton("Wyślij wiadomość");
        wyslijWiadomosc.setPreferredSize(new Dimension(200,50));
        add(wyslijWiadomosc);
    ...
    class Powrot implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, OsadaWroga.this);
