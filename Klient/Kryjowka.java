 ...
 * @author lenovo
 */
//Dodawaj tu action listenera i wyglad Murów Obronnych  
public class Kryjowka extends JPanel{
    ...
    public Kryjowka(PrintWriter wyslij, BufferedReader odbierz, String linia, Integer poziom, String pozycja){
        ...
        ilustracja = new JLabel(new ImageIcon(this.getClass().getResource("kryjowka.png")));
    ...
    class Powrot implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            parent = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, Kryjowka.this);
            ...
            try{
                while((linia=odbierz.readLine())!=null){
                    ...
                    if(tmp[0].equals("Opis")){
                        ...
                        opis.setText("<html>"+tmp[7]+".<br> By rozbudować ten budynke potrzebujesz "+tmp[6]+". <br>Następny poziom kryjówki umożliwi Ci zabezpieczenie "+tmp[5]+"surowców </html>");
                        Kryjowka.this.validate();
                        Kryjowka.this.repaint();
                    }
                    if(tmp.length > 55 ){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(drewno < 0 || glina < 0 || zelazo < 0 || zboze< 0){
                ...
                String sql = "UploadBudynek@"+drewnoIlosc.getText()+"@"+glinaIlosc.getText()+"@"+zelazoIlosc.getText()+"@"+
                        zbozeIlosc.getText()+"@Kryjowka@"+(poziom+1)+"@"+pozycja; // tu jest zawsze 1 bo dopiero budujemy budynek
                wyslij.println(sql);
                wyslij.flush();
                try{
                    Thread.sleep(200);
